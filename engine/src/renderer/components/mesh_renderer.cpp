...
void MeshRendererSerializer::Serialize(JsonArchive& archive, const MeshRenderer& meshRenderer) {
    archive.BeginObject();
    UUIDSerializer::Serialize(archive, meshRenderer.meshId, "meshId");
    archive.EndObject();
}

void MeshRendererSerializer::Deserialize(JsonArchive& archive, MeshRenderer& meshRenderer) {
    archive.BeginObject();
